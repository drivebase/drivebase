import type { MutationResolvers, QueryResolvers, FileResolvers } from "../generated/types";
...
export const fileMutations: MutationResolvers = {
  ...
  moveFile: async (_parent, args, context) => {
    ...
    return fileService.moveFile(args.id, user.userId, args.folderId ?? undefined);
  },
