...
export async function acceptWorkspaceInvite(
	...
	const [invite] = await db
		.select({
			...
			workspaceAutoSyncEnabled: workspaces.autoSyncEnabled,
			workspaceAutoSyncCron: workspaces.autoSyncCron,
			workspaceAutoSyncScope: workspaces.autoSyncScope,
	...
	return {
		...
		autoSyncEnabled: invite.workspaceAutoSyncEnabled,
		autoSyncCron: invite.workspaceAutoSyncCron,
		autoSyncScope: invite.workspaceAutoSyncScope,
