...
import StepOne from '@drivebase/frontend/components/onboarding/step.01';
import StepTwo from '@drivebase/frontend/components/onboarding/step.02';
import StepThree from '@drivebase/frontend/components/onboarding/step.03';
import {
  Card,
  CardHeader,
  CardTitle,
