        ...
        <div className="grid lg:grid-cols-2 gap-0">
          ...
          >
            ...
            <p className="text-muted-foreground mb-8 leading-relaxed">
              ...
              for speed and secure proxy routing when needed. Failed transfers
              are handled automatically, and incomplete uploads are cleaned up.
            </p>
          ...
          <motion.div
            ...
            className="bg-secondary/20 p-4 lg:p-6"
          >
