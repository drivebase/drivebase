      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mx-auto mt-6 max-w-xl text-lg leading-8 text-gray-400">
            Start building with Drivebase today. No credit card required. Open source and free to use.
          </p>
          <div className="mt-10 flex items-center justify-center gap-x-6">
            ...
            <Link href="/docs/api-reference" className="text-sm font-semibold leading-6 text-white hover:text-gray-300 transition-colors">
