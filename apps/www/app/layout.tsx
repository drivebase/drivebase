...
export const metadata: Metadata = {
  ...
  description: 'The unified file storage API for modern applications. Seamlessly integrate secure, scalable file storage with support for S3, Google Drive, and local storage.',
  keywords: ['file storage', 's3', 'google drive', 'local storage', 'open source', 'self-hosted', 'file manager', 'drivebase'],
