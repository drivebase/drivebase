...
export function UploadProviderDialog({
  ...
  const sortedProviders = [...providers].sort((a, b) => Number(b.isActive) - Number(a.isActive));
      ...
      <DialogContent className="sm:max-w-lg">
        ...
        <div className="flex items-start gap-2 rounded-md border bg-muted/30 px-3 py-2">
          ...
          <div className="min-w-0">
            <div className="truncate text-sm font-medium">{fileName || "Unknown file"}</div>
        ...
        <div className="grid grid-cols-2 gap-3">
          {sortedProviders.map((provider) => {
            return (
              ...
              >
                <div className="w-full rounded-lg border border-transparent p-4">
