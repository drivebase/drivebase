...
/**
 * Register every provider module on the process-wide registry. Mirrors
 * `apps/api/providers/registry.ts` — API and workers must share the same
 * provider set so a job queued by the API can be resolved by a worker.
