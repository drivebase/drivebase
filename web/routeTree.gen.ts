...
const ProtectedDashboardRecycleBinRoute = ProtectedDashboardRecycleBinImport.update({
  id: '/recycle-bin',
  path: '/recycle-bin',
  getParentRoute: () => ProtectedDashboardRoute,
} as any);

const ProtectedDashboardFavoritesRoute = ProtectedDashboardFavoritesImport.update({
  id: '/favorites',
  path: '/favorites',
  getParentRoute: () => ProtectedDashboardRoute,
} as any);

const ProtectedDashboardSettingsIndexRoute = ProtectedDashboardSettingsIndexImport.update({
  id: '/settings/',
  path: '/settings/',
  getParentRoute: () => ProtectedDashboardRoute,
} as any);

const ProtectedDashboardSettingsProvidersRoute = ProtectedDashboardSettingsProvidersImport.update({
...
const ProtectedDashboardRouteChildren: ProtectedDashboardRouteChildren = {
  ...
  ProtectedDashboardSettingsProvidersRoute: ProtectedDashboardSettingsProvidersRoute,
  ProtectedDashboardSettingsIndexRoute: ProtectedDashboardSettingsIndexRoute,
};

const ProtectedDashboardRouteWithChildren = ProtectedDashboardRoute._addFileChildren(
  ProtectedDashboardRouteChildren,
);
