...
export type AvailableProvidersQuery = { __typename?: 'Query', availableProviders: Array<{ __typename?: 'AvailableProvider', type: ProviderType, label: string, description: string, authType: AuthType, fields: Array<{ __typename?: 'ProviderFieldDef', name: string, label: string, description?: string | null, placeholder?: string | null, required: boolean }> }> };

export type ProvidersQueryVariables = Exact<{ [key: string]: never; }>;


export type ProvidersQuery = { __typename?: 'Query', providers: Array<{ __typename?: 'Provider', id: any, name: string, type: ProviderType, status: ProviderStatus, authType: AuthType, createdAt: any, quota?: { __typename?: 'ProviderQuota', totalBytes: number, freeBytes: number } | null }> };
