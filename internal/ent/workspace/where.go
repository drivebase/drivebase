...
func HasProviders() predicate.Workspace {
	return predicate.Workspace(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasProvidersWith(preds ...predicate.Provider) predicate.Workspace {
	return predicate.Workspace(func(s *sql.Selector) {
...
func HasRoles() predicate.Workspace {
	return predicate.Workspace(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasRolesWith(preds ...predicate.Role) predicate.Workspace {
	return predicate.Workspace(func(s *sql.Selector) {
		step := newRolesStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
...
func HasUploadBatches() predicate.Workspace {
	return predicate.Workspace(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasUploadBatchesWith(preds ...predicate.UploadBatch) predicate.Workspace {
	return predicate.Workspace(func(s *sql.Selector) {
...
func HasTransferJobs() predicate.Workspace {
	return predicate.Workspace(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasTransferJobsWith(preds ...predicate.TransferJob) predicate.Workspace {
	return predicate.Workspace(func(s *sql.Selector) {
...
func HasSharedLinks() predicate.Workspace {
	return predicate.Workspace(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasSharedLinksWith(preds ...predicate.SharedLink) predicate.Workspace {
	return predicate.Workspace(func(s *sql.Selector) {
...
func HasBandwidthLogs() predicate.Workspace {
	return predicate.Workspace(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasBandwidthLogsWith(preds ...predicate.BandwidthLog) predicate.Workspace {
	return predicate.Workspace(func(s *sql.Selector) {
