...
func (_c *RoleCreate) SetWorkspaceID(v uuid.UUID) *RoleCreate {
...
func (_c *RoleCreate) SetWorkspace(v *Workspace) *RoleCreate {
...
func (_c *RoleCreate) AddMemberIDs(ids ...uuid.UUID) *RoleCreate {
	_c.mutation.AddMemberIDs(ids...)
	return _c
}

// AddMembers adds the "members" edges to the WorkspaceMember entity.
func (_c *RoleCreate) AddMembers(v ...*WorkspaceMember) *RoleCreate {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_c *RoleCreate) check() error {
	if _, ok := _c.mutation.WorkspaceID(); !ok {
		return &ValidationError{Name: "workspace_id", err: errors.New(`ent: missing required field "Role.workspace_id"`)}
	}
	...
	if len(_c.mutation.WorkspaceIDs()) == 0 {
		return &ValidationError{Name: "workspace", err: errors.New(`ent: missing required edge "Role.workspace"`)}
	}
	return nil
}
