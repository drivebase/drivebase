...
func (_u *ApiTokenUpdate) SetDisplayToken(v string) *ApiTokenUpdate {
	_u.mutation.SetDisplayToken(v)
	return _u
}

// SetNillableDisplayToken sets the "display_token" field if the given value is not nil.
func (_u *ApiTokenUpdate) SetNillableDisplayToken(v *string) *ApiTokenUpdate {
	if v != nil {
		_u.SetDisplayToken(*v)
	}
	return _u
}
...
func (_u *ApiTokenUpdate) SetProviderScopes(v []apitoken.ProviderScope) *ApiTokenUpdate {
	_u.mutation.SetProviderScopes(v)
	return _u
}

// AppendProviderScopes appends value to the "provider_scopes" field.
func (_u *ApiTokenUpdate) AppendProviderScopes(v []apitoken.ProviderScope) *ApiTokenUpdate {
	_u.mutation.AppendProviderScopes(v)
	return _u
}

// ClearProviderScopes clears the value of the "provider_scopes" field.
func (_u *ApiTokenUpdate) ClearProviderScopes() *ApiTokenUpdate {
	_u.mutation.ClearProviderScopes()
	return _u
}
...
func (_u *ApiTokenUpdate) check() error {
	if v, ok := _u.mutation.Name(); ok {
		if err := entapitoken.NameValidator(v); err != nil {
...
func (_u *ApiTokenUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	_spec := sqlgraph.NewUpdateSpec(entapitoken.Table, entapitoken.Columns, sqlgraph.NewFieldSpec(entapitoken.FieldID, field.TypeUUID))
	...
	if value, ok := _u.mutation.Name(); ok {
		_spec.SetField(entapitoken.FieldName, field.TypeString, value)
	}
	if value, ok := _u.mutation.TokenHash(); ok {
		_spec.SetField(entapitoken.FieldTokenHash, field.TypeString, value)
	}
	if value, ok := _u.mutation.DisplayToken(); ok {
		_spec.SetField(entapitoken.FieldDisplayToken, field.TypeString, value)
	}
	if value, ok := _u.mutation.Scopes(); ok {
		_spec.SetField(entapitoken.FieldScopes, field.TypeJSON, value)
	}
	if value, ok := _u.mutation.AppendedScopes(); ok {
		_spec.AddModifier(func(u *sql.UpdateBuilder) {
			sqljson.Append(u, entapitoken.FieldScopes, value)
		})
	}
	if value, ok := _u.mutation.ProviderScopes(); ok {
		_spec.SetField(entapitoken.FieldProviderScopes, field.TypeJSON, value)
	}
	if value, ok := _u.mutation.AppendedProviderScopes(); ok {
		_spec.AddModifier(func(u *sql.UpdateBuilder) {
			sqljson.Append(u, entapitoken.FieldProviderScopes, value)
		})
	}
	if _u.mutation.ProviderScopesCleared() {
		_spec.ClearField(entapitoken.FieldProviderScopes, field.TypeJSON)
	}
	if value, ok := _u.mutation.LastUsedAt(); ok {
		_spec.SetField(entapitoken.FieldLastUsedAt, field.TypeTime, value)
	}
	if _u.mutation.LastUsedAtCleared() {
		_spec.ClearField(entapitoken.FieldLastUsedAt, field.TypeTime)
	}
	if value, ok := _u.mutation.ExpiresAt(); ok {
		_spec.SetField(entapitoken.FieldExpiresAt, field.TypeTime, value)
	}
	...
	if _u.mutation.UserCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: true,
			Table:   entapitoken.UserTable,
			Columns: []string{entapitoken.UserColumn},
			Bidi:    false,
	...
	if _node, err = sqlgraph.UpdateNodes(ctx, _u.driver, _spec); err != nil {
		if _, ok := err.(*sqlgraph.NotFoundError); ok {
			err = &NotFoundError{entapitoken.Label}
...
// SetDisplayToken sets the "display_token" field.
func (_u *ApiTokenUpdateOne) SetDisplayToken(v string) *ApiTokenUpdateOne {
	_u.mutation.SetDisplayToken(v)
	return _u
}

// SetNillableDisplayToken sets the "display_token" field if the given value is not nil.
func (_u *ApiTokenUpdateOne) SetNillableDisplayToken(v *string) *ApiTokenUpdateOne {
	if v != nil {
		_u.SetDisplayToken(*v)
	}
	return _u
...
// SetProviderScopes sets the "provider_scopes" field.
func (_u *ApiTokenUpdateOne) SetProviderScopes(v []apitoken.ProviderScope) *ApiTokenUpdateOne {
	_u.mutation.SetProviderScopes(v)
	return _u
}

// AppendProviderScopes appends value to the "provider_scopes" field.
func (_u *ApiTokenUpdateOne) AppendProviderScopes(v []apitoken.ProviderScope) *ApiTokenUpdateOne {
	_u.mutation.AppendProviderScopes(v)
	return _u
}

// ClearProviderScopes clears the value of the "provider_scopes" field.
func (_u *ApiTokenUpdateOne) ClearProviderScopes() *ApiTokenUpdateOne {
	_u.mutation.ClearProviderScopes()
	return _u
}
...
func (_u *ApiTokenUpdateOne) sqlSave(ctx context.Context) (_node *ApiToken, err error) {
	...
	if fields := _u.fields; len(fields) > 0 {
		...
		_spec.Node.Columns = append(_spec.Node.Columns, entapitoken.FieldID)
		for _, f := range fields {
			if !entapitoken.ValidColumn(f) {
				return nil, &ValidationError{Name: f, err: fmt.Errorf("ent: invalid field %q for query", f)}
			}
			if f != entapitoken.FieldID {
