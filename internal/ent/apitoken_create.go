...
func (_c *ApiTokenCreate) SetDisplayToken(v string) *ApiTokenCreate {
	_c.mutation.SetDisplayToken(v)
	return _c
}
...
func (_c *ApiTokenCreate) SetProviderScopes(v []apitoken.ProviderScope) *ApiTokenCreate {
	_c.mutation.SetProviderScopes(v)
	return _c
}
...
func (_c *ApiTokenCreate) defaults() {
	if _, ok := _c.mutation.CreatedAt(); !ok {
		v := entapitoken.DefaultCreatedAt()
		_c.mutation.SetCreatedAt(v)
	}
	if _, ok := _c.mutation.ID(); !ok {
		v := entapitoken.DefaultID()
		_c.mutation.SetID(v)
	}
}
...
func (_c *ApiTokenCreate) check() error {
	...
	if _, ok := _c.mutation.DisplayToken(); !ok {
		return &ValidationError{Name: "display_token", err: errors.New(`ent: missing required field "ApiToken.display_token"`)}
	}
	if v, ok := _c.mutation.DisplayToken(); ok {
...
func (_c *ApiTokenCreate) createSpec() (*ApiToken, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(entapitoken.Table, sqlgraph.NewFieldSpec(entapitoken.FieldID, field.TypeUUID))
	)
