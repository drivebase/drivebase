...
const (
	...
	// FieldDisplayToken holds the string denoting the display_token field in the database.
	FieldDisplayToken = "display_token"
	// FieldScopes holds the string denoting the scopes field in the database.
	FieldScopes = "scopes"
	// FieldProviderScopes holds the string denoting the provider_scopes field in the database.
	FieldProviderScopes = "provider_scopes"
...
var (
	...
	// DisplayTokenValidator is a validator for the "display_token" field. It is called by the builders before save.
	DisplayTokenValidator func(string) error
...
// ByDisplayToken orders the results by the display_token field.
func ByDisplayToken(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldDisplayToken, opts...).ToFunc()
}
