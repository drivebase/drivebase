...
func (_c *ProviderCreate) SetType(v string) *ProviderCreate {
...
func (_c *ProviderCreate) SetAuthType(v string) *ProviderCreate {
...
func (_c *ProviderCreate) SetCredentialID(id uuid.UUID) *ProviderCreate {
...
func (_c *ProviderCreate) SetNillableCredentialID(id *uuid.UUID) *ProviderCreate {
	if id != nil {
...
func (_c *ProviderCreate) SetCredential(v *ProviderCredential) *ProviderCreate {
	return _c.SetCredentialID(v.ID)
}

// SetCacheConfigID sets the "cache_config" edge to the CacheConfig entity by ID.
func (_c *ProviderCreate) SetCacheConfigID(id uuid.UUID) *ProviderCreate {
	_c.mutation.SetCacheConfigID(id)
	return _c
}

// SetNillableCacheConfigID sets the "cache_config" edge to the CacheConfig entity by ID if the given value is not nil.
func (_c *ProviderCreate) SetNillableCacheConfigID(id *uuid.UUID) *ProviderCreate {
	if id != nil {
		_c = _c.SetCacheConfigID(*id)
	}
	return _c
}
...
func (_c *ProviderCreate) AddFileNodeIDs(ids ...uuid.UUID) *ProviderCreate {
	_c.mutation.AddFileNodeIDs(ids...)
	return _c
}

// AddFileNodes adds the "file_nodes" edges to the FileNode entity.
func (_c *ProviderCreate) AddFileNodes(v ...*FileNode) *ProviderCreate {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _c.AddFileNodeIDs(ids...)
}
...
func (_c *ProviderCreate) check() error {
	...
	if _, ok := _c.mutation.AuthType(); !ok {
		return &ValidationError{Name: "auth_type", err: errors.New(`ent: missing required field "Provider.auth_type"`)}
	}
...
func (_c *ProviderCreate) createSpec() (*Provider, *sqlgraph.CreateSpec) {
	...
	if nodes := _c.mutation.CacheConfigIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2O,
			Inverse: false,
	...
	if nodes := _c.mutation.FileNodesIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
