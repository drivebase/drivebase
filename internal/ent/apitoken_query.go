...
func (_q *ApiTokenQuery) First(ctx context.Context) (*ApiToken, error) {
	...
	if len(nodes) == 0 {
		return nil, &NotFoundError{entapitoken.Label}
	}
	return nodes[0], nil
}
...
func (_q *ApiTokenQuery) Only(ctx context.Context) (*ApiToken, error) {
	...
	case 0:
		return nil, &NotFoundError{entapitoken.Label}
	default:
		return nil, &NotSingularError{entapitoken.Label}
	}
}
...
func (_q *ApiTokenQuery) OnlyID(ctx context.Context) (id uuid.UUID, err error) {
	...
	case 0:
		err = &NotFoundError{entapitoken.Label}
	default:
		err = &NotSingularError{entapitoken.Label}
	}
	return
}
...
func (_q *ApiTokenQuery) IDs(ctx context.Context) (ids []uuid.UUID, err error) {
	...
	if err = _q.Select(entapitoken.FieldID).Scan(ctx, &ids); err != nil {
		return nil, err
	}
	return ids, nil
}
...
func (_q *ApiTokenQuery) GroupBy(field string, fields ...string) *ApiTokenGroupBy {
	...
	grbuild.label = entapitoken.Label
...
func (_q *ApiTokenQuery) Select(fields ...string) *ApiTokenSelect {
	...
	sbuild.label = entapitoken.Label
...
func (_q *ApiTokenQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(entapitoken.Table, entapitoken.Columns, sqlgraph.NewFieldSpec(entapitoken.FieldID, field.TypeUUID))
	_spec.From = _q.sql
...
func (_q *ApiTokenQuery) sqlQuery(ctx context.Context) *sql.Selector {
	...
	t1 := builder.Table(entapitoken.Table)
	columns := _q.ctx.Fields
	if len(columns) == 0 {
		columns = entapitoken.Columns
	}
