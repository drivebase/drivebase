...
function parseConfig(config: ProviderConfig): GoogleDriveConfig {
  ...
  if (!parsed.success) {
    throw new ProviderError("google_drive", "Invalid Google Drive configuration", {
...
export async function handleGoogleOAuthCallback(
  ...
  try {
    ...
    throw new ProviderError("google_drive", "Failed to exchange authorization code for tokens", {
      error,
    });
  }
