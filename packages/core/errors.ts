...
export class FileOperationError extends DrivebaseError {
  constructor(
    ...
    super(`File ${operation} failed: ${message}`, "FILE_OPERATION_ERROR", 500, details);
  }
}
...
export class EncryptionError extends DrivebaseError {
  constructor(message: string = "Encryption/Decryption failed", details?: Record<string, unknown>) {
