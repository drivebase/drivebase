import { pgTable, text, timestamp, boolean, bigint, pgEnum } from "drizzle-orm/pg-core";
 ...
 * Provider type enum
 */
export const providerTypeEnum = pgEnum("provider_type", ["google_drive", "s3", "local"]);

/**
 * Authentication type enum
 */
export const authTypeEnum = pgEnum("auth_type", ["oauth", "api_key", "email_pass", "no_auth"]);
