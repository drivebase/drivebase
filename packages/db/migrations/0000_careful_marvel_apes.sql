...
CREATE TYPE "public"."provider_type" AS ENUM('google_drive', 's3', 'local');--> statement-breakpoint
...
ALTER TABLE "activities" ADD CONSTRAINT "activities_provider_id_storage_providers_id_fk" FOREIGN KEY ("provider_id") REFERENCES "public"."storage_providers"("id") ON DELETE set null ON UPDATE no action;